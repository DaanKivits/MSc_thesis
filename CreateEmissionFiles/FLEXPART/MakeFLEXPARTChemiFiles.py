...
# these files with CTE-HR high-resolution fluxes for the biosphere (NEP and wildfires), ocean, and anthropogenic sectors.
...
outdir = '/projects/0/ctdas/dkivits/DATA/FLEXPART/code/fluxes/CTEHR/2018/'
