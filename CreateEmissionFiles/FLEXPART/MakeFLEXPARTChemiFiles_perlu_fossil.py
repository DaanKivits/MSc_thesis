...
# script fills in the 2018 CTE-HR fososil fuel flux fields (anthropogenic) with 2017 CTE-HR fossil fuel (anthropogenic) fluxes for each of the specific landuse types.
