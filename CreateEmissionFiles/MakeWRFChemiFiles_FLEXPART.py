...
outdir = '/projects/0/ctdas/dkivits/DATA/FLEXPART/code/fluxes/CTEHR/'
...
#    fluxstring += sorted(glob.glob(dirname + name + '.201805.nc')) + sorted(glob.glob(dirname + name + '.201806.nc')) + sorted(glob.glob(
...
flexbounds_lon = [-14.875, 35.125]  # in degrees
flexbounds_lat = [33.125, 73.125]  # in degrees
