...
- FLEXPART: contains scripts we used to create FLEXPART-compatible CTE-HR input emission files, 
    also for the PFT-based experiments.
- WRF-CHEM: contains scripts we used to create WRF-CHEM-compatible CTE-HR input emission files.