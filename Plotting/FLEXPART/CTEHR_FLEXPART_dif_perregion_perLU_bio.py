...
# and 2018 - 2017 PFT-based biospheric (bio + fire) injected flux sets. This is only done for the Temperate region.
...
for types in np.unique(lu):
    ...
    Obs = read_hdf("/projects/0/ctdas/dkivits/DATA/FLEXPART/code/ObsPack2018drought_2022update_withbackground_per_lu_" + str(types),key='observations')
    ...
    plt.savefig("/gpfs/work1/0/ctdas/dkivits/figures/CTEHR-FLEXPART/2018drought_CTEHR_FLEXPART_DIF_perregion_perlu_" + str(types) + "_bio.pdf",dpi=300,bbox_inches='tight')
    plt.savefig("/gpfs/work1/0/ctdas/dkivits/figures/CTEHR-FLEXPART/2018drought_CTEHR_FLEXPART_DIF_perregion_perlu_" + str(types) + "bio.png",dpi=300,bbox_inches='tight')
