...
# A simple plotting script used to check the flux set provided by Friedemann Reum (personal communication, 2022) and the same 
# flux set that has been filled with high emissions (2 mol m-2 s-1 (or 7200 mol km-2 hr-1)).
